...
(function ($) {
  ...
  ninja.fn.extend({
    ...
    icons: {alert: '!', arrowDown: 'v', arrowLeft: '<', arrowRight: '>', arrowUp: '^', calendar: 'c', check: '√', chrome: 'C', circle: '•', clear: 'x', clip: '©', diamond: '◊', directions: 'd', edit: 'e', explorer: 'E', facebook: 'f', female: ']', firefox: 'F', flag: 'ƒ', gear: 'g', heart: '¼', heartPlus: '½', heartMinus: '¾', help: '?', home: 'π', infinity: '∞', info: 'i', install: 'I', link: '±', linux: 'L', lock: 'l', mac: 'M', mail: '@', male: '[', map: 'm', moveBack: '‹', moveDown: 'ˇ', moveForward: '›', moveUp: 'ˆ', minus: '-', ninja: 'N', not: 'ø', options: '‡', photo: 'P', plus: '+', remove: 'X', safari: 'S', search: 'Q', shipping: 's', star: '*', thought: 'T', thumbsDown: '≤', thumbsUp: '≥', time: 'Ø', triangle: '∆', tweet: 't', ubuntu: 'U', unlock: 'u', user: '(', users: ')', video: 'V', watch: 'o', weather: 'w', windows: 'W'},
