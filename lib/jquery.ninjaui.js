      ...
      return this.each(function (i, object) {
        ...
        */
        if (options.kuji === 'button') {
          ...
          options.window = $('<span/>', {
            className: 'ninja ninjaInline ninjaWindow',
            css: {
          ...
          $(object).append(options.window.fadeIn('fast'));
          if (options.onCreate) {
            options.onCreate.call(options);
          }
          else {
    ...
    destroy: function (customOptions) {
      return this.each(function (i, object) {
        ...
        if (options.kuji === 'window') {
          $(options.window).fadeOut('fast').remove();
        }
        else {
          $(object).empty().removeData(options);
        }
      });
    },
