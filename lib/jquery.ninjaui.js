/*
  Ninja ui 1.0.alpha.1
  http://ninjaui.com/
  Copyright 2010-2011, Jamie Hoover
  Dependency: jQuery 1.4.4 or higher
*/
/*global jQuery: false*/
/*jslint bitwise: true, browser: true, eqeqeq: true, indent: 2, newcap: true, nomen: true, regexp: true, undef: true, white: true*/
(function ($) {
    ...
    create: function (kuji, customOptions) {
      ...
      return this.each(function (i, object) {
        ...
        if (options.kuji === 'button') {
          ...
          var label = $('<div/>').append($(options.status));
          if (options.title) {
            $(label).prepend($('<span/>', {
