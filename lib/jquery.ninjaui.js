    ...
    disable: function (customOptions) {
      return this.each(function (i, object) {
        ...
        if (options.kuji === 'list') {
          ...
          options.shield = $('<div/>', {
            className: 'ninja ninjaUnselectable ninjaDisabled',
            css: {
          ...
          if (options.values[0]) {
            ...
            $.each(options.values, function (i, value) {
              var choice = $('<div/>', {
                ...
                .mouseover(function () {
                  choice.addClass('ninjaEnabled ninjaGradient');
                })
                ...
                .mouseleave(function () {
                  choice.removeClass('ninjaEnabled ninjaGradient');
                });
              var choiceText = options.names ? options.names[i] : options.value;
              choice.html(value.replace(new RegExp(choiceText, 'gi'), '<strong>' + choiceText + '</strong>'));
