    ...
    create: function (kuji, customOptions) {
      ...
      return this.each(function (i, object) {
        ...
        if (options.kuji === 'button') {
          $(object).addClass('ninjaBorder ninjaButton ninjaInline ninjaUnselectable').css({
          ...
          $(object)
            .removeAttr('id')
            .addClass('ninjaBorder ninjaDrawer ninjaEditable')
            .css({
              width: options.width
            })
            .ninja().round({
          ...
          $(object)
            .addClass('ninja ninjaBorder ninjaEditable ninjaInline ninjaPanel')
            .ninja().round();
          if (options.icon || options.title) {
            var bar = $('<div/>', {
              className: 'ninja ninjaBar ninjaButton ninjaEnabled ninjaGradient ninjaUnselectable'
            })
          ...
          var label = $('<div/>', {
            className: 'ninjaStatus ninjaUnselectable'
          ...
          $(object).addClass('ninja ninjaSuggest').append($(options.input), $(options.list));
          if (options.width) {
        ...
        if (!options.isEnabled) {
          if (options.kuji === 'list') {
            var move = function (direction) {
              var choices = $('.ninja.choice', object).removeClass('ninjaEnabled ninjaGradient'),
    ...
    wait: function (customOptions) {
      return this.each(function (i, object) {
        var options = $.extend({
          message: 'Loading...',
          shield: $('<div/>', {
            className: 'ninja ninjaUnselectable ninjaWait',
            css: {
