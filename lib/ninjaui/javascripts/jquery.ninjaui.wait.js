$.extend($.ninjaui, {
  ...
  waitStart: function(customOptions){
    ...
    $(options.parent).css('position', 'relative').append('<div class="nui nui-wait">' +
      '<div class="nui-wait-frame">' +
        options.message + '<div class="nui-wait-reflection"></div>' +
      '</div>' +
    '</div>');
    var overlay = $('.nui-wait', options.parent);
    ...
    $(overlay).fadeIn(function() {
      ...
      $.ninjaui.framePosition({frame:frame, overlay:overlay});
