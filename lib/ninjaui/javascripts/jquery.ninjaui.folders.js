$.extend($.ninjaui, {
  foldersToggle: function(customOptions){
    ...
    $('.ninjauiFoldersTab', options.folders).each(function(i, tab) {
      if(position == i){
        $(tab).addClass('ninjauiFoldersTabClicked');        
      }
      else{
        $(tab).removeClass('ninjauiFoldersTabClicked');
      }
    });
...
$.extend($.fn.ninjaui, {
  foldersCreate:function(customOptions) {
    ...
    $('.ninjauiFoldersTab:first-child', tabs).addClass('ninjauiFoldersTabFirst');
    $('.ninjauiFoldersTab:last-child', tabs).addClass('ninjauiFoldersTabLast');
